[![Biblioteca Badge](https://img.shields.io/badge/Status-Production%20Ready-green)](https://github.com)

# 📚 Biblioteca - Library Management System

Sistema completo de gestión de bibliotecas construido con **ASP.NET Core 10.0**, **Blazor WebAssembly**, **EF Core**, y **SQL Server LocalDB**.
...
# 2. Crear base de datos (auto-migración)
...
👶 **¿Nuevo en el proyecto?** → Visita **[`.docs/INDEX.md`](.docs/INDEX.md)** (2 minutos)

Toda la documentación está organizada en carpetas:

| Sección | Contenido |
|---------|-----------|
| **📘 [01-Getting-Started](.docs/01-Getting-Started/)** | Guía rápida, primeros pasos |
| **🏗️ [02-Architecture](.docs/02-Architecture/)** | Diseño, endpoints, estructura |
| **💻 [03-Development](.docs/03-Development/)** | Instalación, desarrollo local |
| **🧪 [04-Testing](.docs/04-Testing/)** | Pruebas (12/12 ✅), framework |
| **🚀 [05-Deployment](.docs/05-Deployment/)** | Producción (próximamente) |
| **🐛 [06-Troubleshooting](.docs/06-Troubleshooting/)** | Problemas y soluciones |
...
# Ver endpoints
# Abre en navegador: http://localhost:5088/swagger/index.html
```
...
**Módulos:** Authors | Books | Loans | Reports
...
### 👥 Autores
```csharp
Id, Name, LastName, BirthDate, Country, Biography
CreatedDate, UpdatedDate, IsDeleted
```

### 📖 Libros
```csharp
Id, Title, ISBN, Genre, NumberOfPages, PublishedDate
...
### 🔄 Préstamos
```csharp
Id, BookId (FK), BorrowerName, LoanDate, ExpectedReturnDate
ReturnDate, Status, Penalty
CreatedDate, UpdatedDate, IsDeleted

Regla: MAX 1 préstamo activo por libro
```
...
**100% success rate** - 12 pruebas automatizadas

```
✅ Domain Services Tests       (6)
✅ Integration Tests (EF)       (4)
✅ Serialization Tests          (2)
────────────────────────────
   Total: 12           PASSED: 12
```

Ejecutar: `dotnet test Tests/`
...
```
Biblioteca/
├── .docs/                    ← Documentación (inicio aquí → INDEX.md)
├── scripts/                  ← Scripts de automatización
├── Api/                      ← Capa API
├── Core/                     ← Lógica de dominio
├── Application/              ← DTOs e interfaces
├── Infrastructure/           ← Persistencia (EF Core + Dapper)
├── Tests/                    ← Pruebas automatizadas (xUnit)
└── README.md                 ← Este archivo (RAÍZ LIMPIA)
```
...
Ver colección Postman: `.docs/03-Development/API_COLLECTION.json`
...
### 👤 Usuario Nuevo
→ Lee: [.docs/01-Getting-Started/00-README.md](.docs/01-Getting-Started/00-README.md)

### 💻 Developer
→ Lee: [.docs/03-Development/INSTALLATION_GUIDE.md](.docs/03-Development/INSTALLATION_GUIDE.md)

### 🏗️ Arquitecto
→ Lee: [.docs/02-Architecture/PROJECT_ANALYSIS.md](.docs/02-Architecture/PROJECT_ANALYSIS.md)

### 🧪 QA/Tester
→ Lee: [.docs/04-Testing/README.md](.docs/04-Testing/README.md)
...
| Problema | Solución |
|----------|----------|
| "Database connection failed" | Ver [.docs/06-Troubleshooting/](.docs/06-Troubleshooting/) |
| "Port 5088 already in use" | `netstat -ano \| findstr :5088` |
| "NuGet restore error" | `dotnet nuget locals all --clear` |
...
✅ Comprehensive Testing (xUnit + Moq + EF InMemory)
✅ Auto Database Migration
✅ Image Upload (Book covers)
✅ Loan Management (1 active per book)
✅ Analytics Reports
...
Para más información sobre despliegue, ver: `.docs/05-Deployment/` (próximamente)
...
3. Escribe tests para nuevo código
...
Estructura:
- 📘 01-Getting-Started (Bienvenida)
- 🏗️ 02-Architecture (Diseño técnico)
- 💻 03-Development (Desarrollo local)
- 🧪 04-Testing (Pruebas + Framework)
- 🚀 05-Deployment (Próximamente)
- 🐛 06-Troubleshooting (Problemas)
...
- QUICK: [.docs/01-Getting-Started/00-README.md](.docs/01-Getting-Started/00-README.md)
- COMPLETE: [.docs/02-Architecture/PROJECT_ANALYSIS.md](.docs/02-Architecture/PROJECT_ANALYSIS.md)
